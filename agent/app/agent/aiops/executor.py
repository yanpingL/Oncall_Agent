...
async def executor(state: PlanExecuteState) -> Dict[str, Any]:
    ...
    try:
        ...
        # Creates a LangGraph [ToolNode]
        # ToolNode is responsible for actually executing tool calls requested by the LLM
        """
        The flow is:
        llm_with_tools decides which tool to call
        ↓
        ToolNode runs that tool and returns the result
        ↓
        Tool result goes back into the graph/agent
        """
